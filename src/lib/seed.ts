...
function defaultMetrics(accountId: string, scale = 1): AccountMetrics {
  ...
  return {
    ...
    kpis: [
      ...
      { label: "Alcance", value: `${(1.42 * scale).toFixed(2)}M`, delta: "+18%", detail: "Cuentas alcanzadas", color: "#feda75" },
      ...
      { label: "Guardados", value: `${(31.6 * scale).toFixed(1)}K`, delta: "+26%", detail: "Contenido de alta utilidad", color: "#7a8cff" },
      { label: "Compartidos", value: `${(12.9 * scale).toFixed(1)}K`, delta: "+19%", detail: "Contenido reenviable", color: "#feda75" },
      { label: "DMs", value: `${s(2184)}`, delta: "+38%", detail: "Conversaciones iniciadas", color: "#80ffb5" },
      { label: "Visitas al perfil", value: `${(96.7 * scale).toFixed(1)}K`, delta: "+22%", detail: "Tráfico al perfil", color: "#ff5c9c" },
    ...
    engagementMix: [
      { label: "Me gusta", value: "54%", color: "#7a8cff" },
      { label: "Comentarios", value: "19%", color: "#feda75" },
      { label: "Guardados", value: "14%", color: "#ff5c9c" },
      { label: "Compartidos", value: "8%", color: "#ffa14e" },
      { label: "DMs", value: "5%", color: "#ff5d51" },
    ],
    reachByFormat: [
      { label: "Reels", pct: 92, color: "#7a8cff" },
      { label: "Carr.", pct: 63, color: "#feda75" },
      { label: "Historias", pct: 48, color: "#ff5c9c" },
    ...
    retentionAvg: "42%",
    funnel: [
      { label: "Alcance", value: `${(1.42 * scale).toFixed(2)}M`, pct: 100, color: "#7a8cff" },
      { label: "Visitas al perfil", value: `${(96.7 * scale).toFixed(1)}K`, pct: 68, color: "#feda75" },
...
const piecesSeed: Omit<Piece, "id" | "accountId" | "angle" | "cuerpo">[] = [
  ...
  { format: "Historias", status: "Idea", owner: "Equipo", day: "Jue", time: "19:30", objective: "Agenda", hook: "La diferencia entre contenido bonito y contenido que agenda.", summary: "Historias comparando una pieza tibia contra una con tensión y CTA claro.", cta: "Responder AGENDA", score: 57 },
  ...
  { format: "Historias", status: "Grabado", owner: "Abrahan", day: "Dom", time: "20:00", objective: "Venta", hook: "Si sigues esperando claridad, se te pasa el mercado.", summary: "Secuencia de cierre para mover leads tibios al DM.", cta: "Responder CLARIDAD", score: 74 },
];
...
export function emptyMetrics(accountId: string): AccountMetrics {
  ...
  return {
    ...
    engagementRate: "— ER",
    engagementMix: [
      { label: "Me gusta", value: "0%", color: "#7a8cff" },
      { label: "Comentarios", value: "0%", color: "#feda75" },
      { label: "Guardados", value: "0%", color: "#ff5c9c" },
      { label: "Compartidos", value: "0%", color: "#ffa14e" },
      { label: "DMs", value: "0%", color: "#ff5d51" },
    ],
    reachByFormat: [
      { label: "Reels", pct: 0, color: "#7a8cff" },
      { label: "Carr.", pct: 0, color: "#feda75" },
      { label: "Historias", pct: 0, color: "#ff5c9c" },
    ...
    retentionAvg: "—",
    funnel: [
      { label: "Alcance", value: "—", pct: 0, color: "#7a8cff" },
      { label: "Visitas al perfil", value: "—", pct: 0, color: "#feda75" },
